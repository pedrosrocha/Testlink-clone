...
class testclone_user_list():
    ...
    def delete_user(self, user_id):
        ...
        # return false
        # else database
        user = DatabaseConnector.get_by_id(int(user_id))
        number_of_admins = len(DatabaseConnector.filter_by_level("admin"))

        if user['user_level'] == 'admin' and number_of_admins < 2:
            return False
